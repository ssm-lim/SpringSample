...
<form id="loginForm" method="POST" action="/j_spring_security_check">
	<div class="form-group">
		<input type="text" class="form-control" id="loginUserId" name="j_username" placeholder="UserId">
	</div>
	<div class="form-group">
		<input type="password" class="form-control" id="loginPassword" name="j_password" placeholder="Password">
	</div>
</form>
